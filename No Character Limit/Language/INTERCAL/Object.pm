...
#		my @vararr = ($fl, $sl, $ls, $ll, $ds, $dl, $ge, $xs, $xl, $ru);
#		print "@vararr\n";
	    }
		#print $#cptr . " " . $ncptr . "\n";
	    push @cptr, [$sptr, \@sptr];
